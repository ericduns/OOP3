...
public class NameQueue {
	public static void main (String args[]){
    	...
    	nameQueue.addFirst("Bernadine");
  		...
  		nameQueue.addFirst("Keira");
  		nameQueue.addFirst("Sarah");
  		nameQueue.addFirst("Chloe");
  		 		
  		// display them in order: note the last one is at the top
  		System.out.println("People in the QL \n" + nameQueue);
  		System.out.println("\nThe first Person in the Queue is " + nameQueue.getFirst());
    	System.out.println("\nThe Last Person in the Queue is " + nameQueue.getLast());
